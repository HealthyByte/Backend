...
public class HibernateTemplate {
	...
	public static Object getHealthFormId(int clientId){
		String query1= "from Healthform where clientId = :clientId";
		 Query query = sessionFactory.openSession().createQuery(query1);
		 Client client = new Client();
		 query.setInteger("clientId", client.getClientId());
		  Object queryResult = query.uniqueResult();
		  HealthForm healthForm = (HealthForm)queryResult;
		  return healthForm; 
	}
}
